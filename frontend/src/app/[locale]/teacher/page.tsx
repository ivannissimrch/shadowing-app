...
import StudentProgressCard, { StudentProgress } from "../../components/ui/StudentProgressCard";
...
import { FiUsers, FiBook, FiPlus, FiAlertCircle, FiCheckCircle } from "react-icons/fi";
...
export default function TeacherPage() {
  ...
  const { data: dashboardStats, isLoading: statsLoading } = useSWRAxios<DashboardStats>(
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <StatsCard
            ...
            subtitle={pendingReview > 0 ? tDashboard("needsAttention") : undefined}
